...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        if self.args.model=='SAMformer':
            model_optim=SAM(self.model.parameters(), base_optimizer=torch.optim.Adam, rho=self.args.rho,
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(tqdm(train_loader)):
                ...
                if self.args.use_amp:
                    ...
                    if model_optim.__class__.__name__ == 'SAM':
                        ...
                        out_batch = self.model(batch_x, batch_x_mark, dec_inp, batch_y_mark)
                        loss = criterion(out_batch, batch_y)
